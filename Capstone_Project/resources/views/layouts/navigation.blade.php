            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="space-x-4 flex items-center">
                        <a href="{{ route('login') }}" class="text-gray-700 dark:text-gray-200 hover:text-blue-600 font-medium">
                            {{ __('Login') }}
                        </a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700">
                                {{ __('Register') }}
                            </a>
                        @endif
                    </div>
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('user-profile.userProfile')">
                        {{ __('Profile') }}
                    </x-responsive-nav-link>
